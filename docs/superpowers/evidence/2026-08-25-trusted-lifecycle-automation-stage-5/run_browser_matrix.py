"""Run the Stage 5 fixture-only bilingual browser matrix."""
...
def _summary() -> dict:
    return {
        ...
        "automation_tier": "review_suggested",
...
def _run_entry(browser, width: int, height: int, locale: str) -> dict:
    ...
    for text in (
        ...
        *labels["families"],
        ...
        assert text in drawer_text, text
    ...
    assert facts_scroll_top > evidence_scroll_top, (evidence_scroll_top, facts_scroll_top)
