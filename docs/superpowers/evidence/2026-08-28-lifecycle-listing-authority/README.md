...
- Each M01-M33 entry runs its unchanged declared pytest command before mutation,
...
- `mutation-ledger.json`: M01-M33 baseline/mutant commands, exact nodes, signatures,
