...
- Each M01-M34 entry runs its unchanged declared pytest command before mutation,
...
- `mutation-ledger.json`: M01-M34 baseline/mutant commands, exact nodes, signatures,
